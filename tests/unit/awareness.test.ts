...
import { buildAwarenessState, parseCollaborators } from '../../src/session/awareness.js';
...
describe('parseCollaborators', () => {
  ...
  it('filters out own client ID', () => {
    const awareness = {
      ...
      '200': { collaboratorInfo: { ...otherCollaborator, id: 3, name: 'Other' } },
    };
  ...
  it('returns empty array for solo editing', () => {
    const awareness = {
      '100': { collaboratorInfo: { ...otherCollaborator, id: 1, name: 'Me' } },
    };
  ...
  it('returns multiple collaborators', () => {
    const other1: CollaboratorInfo = { ...otherCollaborator, id: 2, name: 'Editor1' };
    const other2: CollaboratorInfo = { ...otherCollaborator, id: 3, name: 'Editor2' };
