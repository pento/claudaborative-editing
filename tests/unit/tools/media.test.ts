	...
	describe('wp_upload_media', () => {
		...
		it('shows video insertion hint for video uploads', async () => {
			const videoMedia = {
				...
				mime_type: 'video/mp4',
				source_url:
					'https://example.com/wp-content/uploads/2026/03/clip.mp4',
		...
		it('shows audio insertion hint for audio uploads', async () => {
			const audioMedia = {
				...
				source_url:
					'https://example.com/wp-content/uploads/2026/03/song.mp3',
				media_details: {},
			};
			(
				session.uploadMedia as ReturnType<typeof import('vitest').vi.fn>
		...
		it('shows file insertion hint for document uploads', async () => {
			const pdfMedia = {
				...
				source_url:
					'https://example.com/wp-content/uploads/2026/03/doc.pdf',
				media_details: {},
			};
			(
				session.uploadMedia as ReturnType<typeof import('vitest').vi.fn>
