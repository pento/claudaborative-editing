 ...
 *
 * Always leads with CollaborationNotice (so it also shows while cloud
 * settings are connecting). When cloud settings are configured, shows a
 * "Connecting..." message instead of setup instructions. Otherwise renders
 * two setup option cards: hosted cloud service and local CLI setup.
 *
